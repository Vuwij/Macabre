...
public class PixelPerfectObject : MonoBehaviour {
	...
	public bool runContinously=false;
	...
	void SetPixelPerfectScale() {
		//transform.localScale = new Vector3 (0.03125f, 0.03125f, 1);
		transform.localScale = new Vector3 (GetTransformScaleFactor (), GetTransformScaleFactor (), 1);
	...
	protected virtual float GetTransformScaleFactor() {
		return (PixelPerfect.pixelsPerUnit*PixelPerfect.worldPixelSize)*pixelScale*1;
	}
