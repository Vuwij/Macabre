...
namespace IngameDebugConsole
{
	...
	public static class DebugLogConsole
	{
		...
		private static List<string> commandArguments = new List<string>( 100 );
		...
		[ConsoleMethod("do", "Does a event argument")]
		public static void EventArgument(string something)
		{
			commandArguments.RemoveAt(0);
			GameObject gameManager = GameObject.Find("Game Manager");
			gameManager.SendMessage("AddGameTask", commandString.Replace("do ", ""));
		}
