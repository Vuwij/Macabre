...
/// 
/// </summary>
public class MacabreSceneManager : Manager
{
	public static MacabreSceneManager main;

	// The Dictionary of Scenes, all the Scenes have a string
	public Dictionary<string, MacabreScene> sceneList;
	...
	// This function loads all the scenes into the game
	...
	private void ChangeSceneSpecial (string s)
	{
		switch (s) {
		case "Start":
			UIManager.main.TurnOnScreen ("Start Screen");
