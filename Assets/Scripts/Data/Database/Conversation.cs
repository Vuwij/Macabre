...
namespace Data.Database {
    ...
    public static partial class DatabaseManager {
        ...
        /// </summary>
        bool[] CONVO_Prerequisites = new bool[GameSettings.ConversationCharacterLimit];
        ...
        public singleConversation CONVO_continue(string characterName, int playerChoice, bool openChoice) {
            ...
            if (GameSettings.debugDATA) Debug.Log(Conversation[0]);
            for (int i = 0; i < 4; i++) {
        ...
        public void CONVO_printAllPrerequisites() {
            ...
            int pile = 0;
            string boolstring = "";
            for (int i = 1; i < GameSettings.ConversationCharacterLimit; i++) {
                if (CONVO_Prerequisites[i]) {
                    pile = 0;
                    boolstring += "1";
                } else {
