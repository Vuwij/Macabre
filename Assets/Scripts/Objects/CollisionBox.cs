...
namespace Objects
{
	public class CollisionBox
	{
		...
		PolygonCollider2D proximityBox;
		SpriteRenderer renderer;
		EdgeCollider2D edgeCollider2D;

		public enum type { circle }
		public int radiusX;
		public int radiusY;
		...
		public CollisionBox (GameObject gameObject)
		{
			...
			this.edgeCollider2D = gameObject.GetComponent<EdgeCollider2D>();

			// Creating Collision Circle

			// Creating BackEdge Collider
		...
		public EdgeCollider2D CreateBackEdgeCollider()
		{
		...
		void GetMaximaPoints(Vector2[] points, out int leftIndex, out int rightIndex, out float leftMostPoint, out float rightMostPoint)
		{
			leftIndex = 0;
			rightIndex = 0;
		...
		void AddLeftAndRightEdges(ref List<Vector2> backEdgePointsOfObject)
		{
