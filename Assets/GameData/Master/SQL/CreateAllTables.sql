...
CREATE TABLE IF NOT EXISTS `Conversations_GerdnesAberdeen` ( `StateName` TEXT NOT NULL UNIQUE, `AddStates` TEXT NOT NULL, `CurrentSpeaker` TEXT NOT NULL, `Dialogue` TEXT NOT NULL, `Action` TEXT, `AddEvents` TEXT, `RemoveEvents` TEXT, `RequireEvents` TEXT, `ExcludeEvents` TEXT, PRIMARY KEY(`StateName`), FOREIGN KEY(`CurrentSpeaker`) REFERENCES `Game_Characters`(`Name`), FOREIGN KEY(`AddEvents`) REFERENCES `Game_Events`(`Name`), FOREIGN KEY(`RemoveEvents`) REFERENCES `Game_Events`(`Name`), FOREIGN KEY(`RequireEvents`) REFERENCES Game_Events(Name) );
CREATE TABLE IF NOT EXISTS `Conversations_OwinThePardoner` ( `StateName` TEXT NOT NULL UNIQUE, `AddStates` TEXT NOT NULL, `CurrentSpeaker` TEXT NOT NULL, `Dialogue` TEXT NOT NULL, `Action` TEXT, `AddEvents` TEXT, `RemoveEvents` TEXT, `RequireEvents` TEXT, `ExcludeEvents` TEXT, PRIMARY KEY(`StateName`), FOREIGN KEY(`CurrentSpeaker`) REFERENCES `Game_Characters`(`Name`), FOREIGN KEY(`AddEvents`) REFERENCES `Game_Events`(`Name`), FOREIGN KEY(`RemoveEvents`) REFERENCES `Game_Events`(`Name`), FOREIGN KEY(`RequireEvents`) REFERENCES Game_Events(Name) );
CREATE TABLE IF NOT EXISTS `Conversations_HamenTheInnkeeper` ( `StateName` TEXT NOT NULL UNIQUE, `AddStates` TEXT NOT NULL, `CurrentSpeaker` TEXT NOT NULL, `Dialogue` TEXT NOT NULL, `Action` TEXT, `AddEvents` TEXT, `RemoveEvents` TEXT, `RequireEvents` TEXT, `ExcludeEvents` TEXT, PRIMARY KEY(`StateName`), FOREIGN KEY(`CurrentSpeaker`) REFERENCES `Game_Characters`(`Name`), FOREIGN KEY(`AddEvents`) REFERENCES `Game_Events`(`Name`), FOREIGN KEY(`RemoveEvents`) REFERENCES `Game_Events`(`Name`), FOREIGN KEY(`RequireEvents`) REFERENCES Game_Events(Name) );
...
CREATE TABLE `Items_Combine` ( `CombinedItemID` INTEGER NOT NULL, `ItemID1` INTEGER NOT NULL, `ItemID2` INTEGER NOT NULL, FOREIGN KEY(`ItemID1`) REFERENCES Items_ClassB(ID), FOREIGN KEY(`ItemID2`) REFERENCES Items_ClassA(ID) );
